    ...
    <section id="home" className="relative w-full flex flex-col items-center justify-center min-h-screen py-20">
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
           ...
           */}
          <TextGenerateEffect
            words="Bringing Ideas to Life Through Code & Creativity"
            className="text-center text-[40px] md:text-5xl lg:text-6xl"
          />

          <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
            Hi! I&apos;m Mihika, a Computer Science undergrad at IIT Patna and a passionate developer building everything from smart apps to AI-powered games.
          </p>
