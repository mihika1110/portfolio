    ...
    <div className="flex flex-wrap gap-8 justify-center max-w-4xl">
      {statuses.map((status, idx) => (
        <motion.div
          ...
          className="px-8 py-6 rounded-2xl bg-transparent text-white font-medium shadow-lg hover:scale-105 hover:shadow-blue-400/40 transition-all duration-300 border border-blue-400/30 text-center"
        >
